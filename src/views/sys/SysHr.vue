...
<script>
    export default {
        ...
        methods: {
            async enabledChange(hr) {
                delete hr.roles;
                const resp = this.putRequest("/system/hr", hr);
                if (resp) this.initHrs();
